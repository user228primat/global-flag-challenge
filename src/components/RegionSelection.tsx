    ...
    <div className="w-full max-w-xl mx-auto px-4">
      <div className="flex items-center mb-8">
        <Button 
          onClick={() => navigate('/')}
          variant="ghost" 
          className="text-indigo-300 hover:text-indigo-100 hover:bg-indigo-900/30"
        >
      ...
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold mb-2 text-indigo-100 text-shadow animate-fade-in">
          Выберите регион
        </h1>
        <p className="text-indigo-300/80 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          Для изучения столиц
        </p>
      </div>
          ...
          return (
            <button
              ...
              className="p-0 rounded-xl text-center transition-all duration-300 
                        hover:bg-indigo-900/30 flex flex-col items-center overflow-hidden
                        hover:scale-[1.02] hover:shadow-lg relative
                        border border-indigo-800/30 bg-gradient-to-br from-indigo-950/70 to-blue-950/50 backdrop-blur-sm shadow-md"
              style={{ 
                opacity: 0,
            ...
            >
              ...
              <div className="w-full p-4 z-10 relative">
                <div className="flex flex-col items-center justify-center">
                  <Globe size={32} className="mb-2 text-sky-300" />
                  <span className="text-xl font-medium text-indigo-100">
                    {categoryDisplayNames[regionId as CategoryId]}
                  </span>
                </div>
                
                <div className="flex items-center justify-between mt-2 text-sm text-indigo-200/90">
                  <div className="flex items-center mr-2">
                    <BookOpen size={12} className="mr-1 text-indigo-300" />
              ...
              {/* Overlay effect */}
              <div className="absolute inset-0 bg-gradient-to-t from-indigo-950 via-blue-950/50 to-transparent opacity-70" />
